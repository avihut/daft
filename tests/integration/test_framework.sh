...
ensure_rust_binaries() {
    ...
    local symlink_names=("git-worktree-clone" "git-worktree-init" "git-worktree-checkout" "git-worktree-branch-delete" "git-worktree-prune" "git-worktree-carry" "git-worktree-exec" "git-worktree-fetch" "git-worktree-flow-adopt" "git-worktree-flow-eject" "git-worktree-list" "git-daft" "daft-remove" "daft-rename" "gwtclone" "gwtinit" "gwtco" "gwtcb" "gwtprune" "gwtcarry" "gwtfetch" "gwtbd" "gwtls")
