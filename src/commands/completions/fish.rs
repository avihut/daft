...
complete -c daft -n '__fish_seen_subcommand_from merge worktree-merge' -s r -l remove -d 'Remove the source worktree after a successful merge'
complete -c daft -n '__fish_seen_subcommand_from merge worktree-merge' -s b -l and-branch -d 'Also delete the source branch (requires --remove)'
...
complete -c daft -n '__fish_seen_subcommand_from merge worktree-merge' -l ff -d 'Allow fast-forward merges'
complete -c daft -n '__fish_seen_subcommand_from merge worktree-merge' -l no-ff -d 'Always create a merge commit'
complete -c daft -n '__fish_seen_subcommand_from merge worktree-merge' -l ff-only -d 'Refuse merge if fast-forward is not possible'
complete -c daft -n '__fish_seen_subcommand_from merge worktree-merge' -l squash -d 'Squash source changes into a single staged diff'
complete -c daft -n '__fish_seen_subcommand_from merge worktree-merge' -l no-squash -d 'Explicitly disable squash'
