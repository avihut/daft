...
Worktrees with uncommitted changes are skipped unless --force is specified. Use
--dry-run to preview what would be done without making changes.

Arguments after -- are passed directly to git pull, allowing full control over
the pull behavior.
