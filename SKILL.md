...
| Command                             | Description                                                                                                                                                                                                                                                              |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `daft worktree-list [--json]`       | List all worktrees with branch (`*` = default), path (relative to cwd), base ahead/behind, head changes (~N), remote ahead/behind, branch age, and commit info. JSON includes `is_default_branch`, `head_changes`, `remote_ahead`, `remote_behind`, `branch_age` fields. |
