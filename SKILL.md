...
| `daft repo install [--quiet\|-q] [--verbose\|-v]`                                                | Write a starter `daft.yml` (commented skeleton: `hooks:`, `shared:`, `layout:`) at the current worktree root, modeled on `lefthook install`. Refuses if `daft.yml` already exists. No git side effects (does not touch `.gitignore`/`.git/info/exclude`). Canonical name; `daft install` is a top-level alias for the same command.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
