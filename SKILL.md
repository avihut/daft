...
| `daft config list [--modified] [--format json]`                                 | Every daft setting with its current value and the layer that decided it. `--modified` shows only what something sets. Use this to find a key rather than guessing at one.                                                                                                                                                                                                                                                                                 |
